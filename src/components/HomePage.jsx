      ...
      <div className="min-h-screen bg-white bg-[radial-gradient(ellipse_at_bottom,rgba(0,0,0,0.1)_0%,transparent_60%)] flex flex-col">
        <header className="flex justify-between items-center p-4 sm:p-5">
          <Link to="/" className="text-2xl font-bold text-purple-600">
            <Logo className="text-[#225FC3] w-32 sm:w-40 md:w-[167px]" color="currentColor" />
          </Link>
          <Link
            to="/signup"
    ...
    <div className="text-white relative overflow-hidden min-h-screen bg-[#0f0f20] flex flex-col">
      ...
      <div className="absolute inset-0 z-0 min-h-full">
        ...
        <img
          ...
          alt="Decorative background vector graphic"
          src="/vector.svg"
          loading="lazy"
        />
        ...
        <div className="flex overflow-hidden relative justify-center items-center w-full">
          <div className="flex relative flex-col gap-6 items-center w-[1244px] min-h-[578px] h-auto max-md:px-4 max-md:py-2 max-md:w-full max-md:mt-10 min-[320px]:w-full bg-transparent ">
            <div className="flex flex-col gap-2 sm:gap-3 items-center text-center mt-10 sm:mt-10">
              <h1 className="mb-2 sm:mb-3 text-4xl sm:text-5xl md:text-6xl font-bold w-full max-w-[740px] px-4">
                <span className="text-[#FFFFFF4D] text-opacity-30 font-bold text-4xl sm:text-5xl md:text-[65px] leading-tight sm:leading-snug tracking-normal [-webkit-text-stroke:0.5px_white]">
                  Generate{" "}
                </span>
              ...
              <p className="text-base sm:text-xl text-[#F7F8FA] font-normal leading-relaxed tracking-normal px-4 text-center max-w-[740px]">
