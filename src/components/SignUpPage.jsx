  ...
  return (
    <div className="min-h-screen bg-white bg-[radial-gradient(ellipse_at_bottom,rgba(0,0,0,0.1)_0%,transparent_60%)] flex flex-col">
      <header className="flex justify-between items-center p-4 sm:p-5">
        ...
        <Link
          to="/login-page"
          className="text-[#225FC3]   rounded shadow flex items-center gap-1 py-2 px-4 font-medium text-sm  text-center hover:bg-gray-100 transition-colors"
        >
          Login
          <GoArrowRight size={20} className="ml-0.5" />
        </Link>
      </header>
          ...
          {step === 1 ? (
            <>
              ...
              <form onSubmit={handleSubmit}>
                ...
                >
                  Continue
                  <GoArrowRight className="ml-2 w-4 sm:w-5 h-4 sm:h-5" />
                </button>
              </form>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="flex flex-wrap gap-4 sm:gap-4 mb-4">
                  <div className="flex items-center">
                    ...
                    <span className="text-[#666F8D] font-light text-xs leading-none tracking-normal text-[#666F8D">
                      8 character
                    </span>
                  </div>
                  <div className="flex items-center">
