      ...
      {isHeaderBlurred ? (
        ...
        <div className="relative flex flex-row justify-between items-center mb-2 ">
          <div className="relative flex-1 text-center ">
            <h3
              className={`font-inter text-sm leading-none tracking-normal ${
                activeTab === "Conversation"
                  ? "text-[#625DCD]"
                  : "text-[#7A7A7A] cursor-pointer"
              }`}
            ...
            <div
              className={`absolute bottom-[-8px] left-0 w-full h-px border-b-2 ${
                activeTab === "Conversation"
                  ? "border-[#625DCD]"
                  : "border-[#F0F2F5]"
              }`}
          ...
          <div className="relative flex-1 text-center">
            <h3
              className={`font-inter font-normal text-sm leading-none tracking-normal ${
                activeTab === "Static"
                  ? "text-[#625DCD]"
                  : "text-[#7A7A7A] cursor-pointer"
              }`}
            ...
            <div
              className={`absolute bottom-[-8px] left-0 w-full h-px border-b-2 ${
                activeTab === "Static" ? "border-[#625DCD]" : "border-[#F0F2F5]"
              }`}
            ></div>
          </div>
        </div>
        ...
        <div className="space-y-1">
          ...
          <div
            className={`flex-1 px-3 ${
              activeTab === "Static" ? "mt-[20px]" : "mt-[330px]"
            } space-y-3`}
          >
              ...
              {isTextBlurred ? (
                ...
                <div className="relative border border-[#4A77B5] rounded-tr-lg rounded-br-lg rounded-tl-lg px-3 py-2 max-w-[80%]">
                  <p className="leading-5 text-[#333333] text-xs">
                    Hi! I'm Luna, your assistant. Here to guide you with expert
                    advice on Hair Fall Treatment in India.
                  </p>
